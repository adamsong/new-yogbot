...
@Component
public class YoggersCommand extends ImageCommand {
	public YoggersCommand(DiscordConfig discordConfig, Random random) {
	...
	protected String getTitle() {
		return "Playerbase Image";
	}
	
	@Override
	protected String getDescription() {
		return "Random shit that happens";
	}
