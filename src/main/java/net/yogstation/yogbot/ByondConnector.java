...
public class ByondConnector {
	...
	public ByondConnector(ByondConfig config) {
		this.config = config;
	}
	
	public Result<Object, String> request(String rawQuery) {
		String query = String.format("%s&key=%s", rawQuery, config.serverKey);
