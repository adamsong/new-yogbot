...
@Component
public class MojaCommand extends ImageCommand {
	public MojaCommand(DiscordConfig discordConfig, Random random) {
	...
	protected String getDescription() {
		return "Wise words beyond mortal comprehension";
	}
